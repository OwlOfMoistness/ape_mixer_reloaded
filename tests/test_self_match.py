...
def test_single_bayc_self_match(matcher, ape, bayc, nft_guy, coin_guy, ape_staking, smooth, chain):
	...
	assert (dogless & 1, ids, pO, pT, dO, dT) == (1, 1, nft_guy, nft_guy, NULL, NULL)
...
def test_single_mayc_self_match(matcher, ape, mayc, nft_guy, coin_guy, ape_staking, smooth, chain):
	...
	assert (dogless & 1, ids, pO, pT, dO, dT) == (0, 2, nft_guy, nft_guy, NULL, NULL)
...
def test_many_bayc_self_match(matcher, ape, bayc, nft_guy, coin_guy, ape_staking, smooth, chain):
	...
	assert (dogless & 1, ids, pO, pT, dO, dT) == (1, 3, nft_guy, nft_guy, NULL, NULL)
	(dogless, ids, pO, pT, dO, dT) = matcher.matches(3)
	assert (dogless & 1, ids, pO, pT, dO, dT) == (1, 4, nft_guy, nft_guy, NULL, NULL)
	(dogless, ids, pO, pT, dO, dT) = matcher.matches(4)
	assert (dogless & 1, ids, pO, pT, dO, dT) == (1, 5, nft_guy, nft_guy, NULL, NULL)
	assert matcher.alphaSpentCounter() == 0
...
def test_many_mayc_self_match(matcher, ape, mayc, nft_guy, coin_guy, ape_staking, smooth, chain):
	...
	assert (dogless & 1, ids, pO, pT, dO, dT) == (0, 6, nft_guy, nft_guy, NULL, NULL)
	(dogless, ids, pO, pT, dO, dT) = matcher.matches(6)
	assert (dogless & 1, ids, pO, pT, dO, dT) == (0, 7, nft_guy, nft_guy, NULL, NULL)
	(dogless, ids, pO, pT, dO, dT) = matcher.matches(7)
	assert (dogless & 1, ids, pO, pT, dO, dT) == (0, 8, nft_guy, nft_guy, NULL, NULL)
	assert matcher.betaSpentCounter() == 0
